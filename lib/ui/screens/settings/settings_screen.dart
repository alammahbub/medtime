        ...
        children: [
          ...
          FutureBuilder<Map<String, TimeOfDay>>(
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                children: times.entries.map((e) => _SettingTile(
                  ...
                  onTap: () async {
                    ...
                    if (t != null) {
                      final newTimes = Map<String, TimeOfDay>.from(times);
                      newTimes[e.key] = t;
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Updating schedules...'), duration: Duration(seconds: 1)));
                        await context.read<MedicationProvider>().recalculateMealSchedules();
                      }
                    }
                  },
                )).toList(),
          ...
          _SettingTile(
            ...
            onTap: () async {
              ...
              await prefs.clear();
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('App reset. Please restart the app.')));
              }
            },
          ),
          const SizedBox(height: 24),
  ...
  Future<void> _confirmClear(BuildContext context) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('This will permanently delete all your medications and history. This cannot be undone.'),
        actions: [
...
class _SectionHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Text(title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppTheme.primary)),
  );
}
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: color)),
